...
// SAHNE GÖRSELLERİ: Her senaryonun geleneksel ve Montessori yaklaşımı görseli.
const sceneImages: Record<string, { wrong: string; right: string }> = {
  ...
  rules: {
    wrong: "/scenes/03-game-rules-dont.png",
    right: "/scenes/03-game-rules-do.png",
  },
  teams: {
    wrong: "/scenes/04-team-selection-dont.png",
    right: "/scenes/04-team-selection-do.png",
  },
  swing: {
    wrong: "/scenes/05-swing-turn-dont.png",
    right: "/scenes/05-swing-turn-do.png",
  },
  ages: {
    wrong: "/scenes/06-age-hierarchy-dont.png",
    right: "/scenes/06-age-hierarchy-do.png",
  },
  nickname: {
    wrong: "/scenes/07-teasing-dont.png",
    right: "/scenes/07-teasing-do.png",
  },
};
...
const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    context: "Ali, su sırasında yandan en öne geçti; uzun süredir bekleyen Selin bu durumun adil olmadığını söyledi.",
    names: { a: "Selin", b: "Ali" },
    ...
    wrong: [
      ...
      { speaker: "b", text: "Ama çok susamıştım; yalnızca hızlıca su içecektim." },
    ...
    right: [
      ...
      { speaker: "b", text: "Sadece hızlıca su içmek istemiştim." },
      { speaker: "teacher", text: "Herkes susadığında sıranın önüne geçseydi en arkadakilerin süresi nasıl etkilenirdi?" },
      { speaker: "b", text: "Herkes kendi sırasını beklemeli. Ben de en arkaya geçebilirim." },
    ],
    ...
    question: "Ali, susuzluğunu giderirken sıradakilerin hakkını da nasıl koruyabilir?",
    choices: [
      { id: "a", text: "Yalnızca bir yudum alacağım için doğrudan öne geçerim.", correct: false, feedback: "Kısa sürmesi, geride bekleyen herkesin sırasını değiştirdiği gerçeğini ortadan kaldırmaz." },
      { id: "b", text: "Sıranın sonuna geçer, herkes gibi kendi sıramı beklerim.", correct: true, feedback: "Ortak düzen ve diğer çocukların zamanı korunuyor." },
      { id: "c", text: "Öğretmen görmeden hızlıca suyumu içerim.", correct: false, feedback: "Gizlemek, adalet sorununu çözmez; yalnızca görünmez yapar." },
    ],
    ...
    starters: {
      ...
      b: "Çok susadığım için … yaptım; sırayı korumak için şimdi … yapabilirim.",
    },
    guide: {
      notice: "Kaynak yapan tek çocuğa odaklanmadan, davranışın bütün kuyruğun süresini nasıl değiştirdiğini görünür kılın.",
      questions: ["Herkes susadığında öne geçseydi ne olurdu?", "Kısa sürecek olması sırayı değiştirmeyi adil yapar mı?", "Herkes için uygulanabilecek kural hangisi?"],
  ...
  },
  {
    ...
    context: "Bahçe maçında top kale çizgisine yaklaştı; fakat kale direği olan konilerden biri kaydığı için gol tartışmalı.",
    names: { a: "Mert", b: "Duru" },
    ...
    right: [
      ...
      { speaker: "b", text: "Sağdaki koni kaydığı için kale sınırı net değildi." },
      { speaker: "a", text: "Konileri birlikte hizalayıp bu pozisyonu saymadan adil bir başlangıç yapalım mı?" },
      { speaker: "b", text: "Tamam. Topu ortaya koyup yeniden başlayalım." },
    ],
    wrongResult: "Tartışma sustu; çocukların kural kurma ve müzakere becerisi de sustu.",
    rightResult: "Belirsizlik kabul edildi, koniler hizalandı ve iki tarafın kabul ettiği adil bir yeniden başlangıç yapıldı.",
    ...
    choices: [
      ...
      { id: "b", text: "Belirsiz pozisyonu saymadan topu ortaya koyalım ve konileri birlikte hizalayalım.", correct: true, feedback: "Geçmişteki belirsizlik yönetiliyor, sonraki pozisyon için hata denetimi kuruluyor." },
    ...
    thinking: ["Ne biliyoruz? Topun yeri görüldü ama konilerden biri kaymıştı.", "Nerede belirsizlik var? Kale sınırında.", "Sonraki hata nasıl önlenir? Konileri hizalayıp ortak bir yeniden başlangıç yapmak."],
    starters: {
    ...
    guide: {
      ...
      environment: "Kale konilerini görünür, düz ve eşit aralıklı yerleştirmek çevrenin hata denetimini güçlendirir.",
  ...
  },
  {
    ...
    context: "Can salıncakta; Ece 10’a kadar saydı fakat Can bu sürenin çok kısa olduğunu düşünüyor.",
    names: { a: "Ece", b: "Can" },
    ...
    wrong: [
      { speaker: "teacher", text: "Can, süren bitti. Hemen in!" },
    ...
    right: [
      ...
      { speaker: "b", text: "Kum saatiyle üç dakika olsun. Bitince kendim sırayı veririm." },
      { speaker: "a", text: "Tamam, kum saatini ben çeviriyorum." },
    ],
    ...
    choices: [
      ...
      { id: "b", text: "Birlikte belirlenen süreyi kum saatiyle ölçüp bitince sırayı devredelim.", correct: true, feedback: "Sınır somut, önceden bilinen ve iki çocuk için de uygulanabilir." },
  ...
  },
  {
    ...
    context: "Deniz’in kalemleri kazayla yere düşünce Arda ona ‘sakar’ diyerek güldü; Deniz utandı ve kalem kutusunu kendine çekti.",
    ...
    right: [
      { speaker: "teacher", text: "Deniz, kalemlerin düştükten sonra sessizleştiğini fark ettim. Ne hissettiğini Arda ile paylaşmak ister misin?" },
      { speaker: "a", text: "Kalemlerim düştüğünde bana ‘sakar’ deyip güldüğünde utandım ve kırıldım. Kazalarım üzerinden alay edilmesini istemiyorum." },
      { speaker: "b", text: "Komik olduğunu düşünmüştüm; seni böyle etkilediğini anlamamıştım." },
      { speaker: "b", text: "Özür dilerim. Bir daha kazalarınla alay etmeyeceğim; kalemlerini toplamaya yardım edebilirim." },
    ...
    thinking: ["Ne oldu? Küçük bir kaza alay ve etikete dönüştü.", "Niyet ve etki aynı mı? Hayır; komik niyet incitici etkiyi silmez.", "Yeni sınır ne? Birinin hatası veya kazası üzerinden alay edilmemesi."],
    starters: {
      a: "… olduğunda bana … dediğinde kendimi … hissettim. Bununla ilgili alay edilmesini istemiyorum.",
    ...
    guide: {
      ...
      environment: "Zarafet ve Kibarlık sunumlarında küçük kazalar, hata anları, lakaplar ve kişisel sınırlar üzerine gerçekçi kısa canlandırmalar yapın.",
...
const academicReadings: Record<string, { focus: string; reading: string; indicator: string; prompt: string }> = {
  ...
  queue: {
    focus: "Ahlaki akıl yürütme ve toplumsal düzen",
  ...
  teams: {
    ...
    reading: "Karma yaş topluluğunda katılım yalnızca oyuna fiziksel olarak alınmak değildir. Seçim yönteminin her çocuğun topluluktaki değerine ilişkin verdiği mesajı incelemek, sosyal adalet akıl yürütmesini görünür kılar.",
    ...
    <main className={"book-app chapter-" + chapter}>
      ...
      {chapter === "compare" && (
        <section className="book-page compare-page page-enter" key={"compare-" + scene.id}>
          <PageHeading number="01" eyebrow="BUNU YAPMA / BUNU YAP" title="Aynı olay, iki yetişkin tavrı." text="Montessori yaklaşımında yetişkinin sözü azalırken çocuğun akıl yürütme alanı büyür. Baloncukları oynatıp farkı görün." onHome={() => goChapter("cover")} />
        ...
        <section className="book-page practice-page page-enter" key={"practice-" + scene.id}>
          ...
          <div className="practice-layout">
            <aside className="thinking-ladder">
              <SceneVignette scene={scene} />
              <small>MONTESSORİ AKIL YÜRÜTME MERDİVENİ</small>
              <h2>{scene.title}</h2>
            ...
            <article className={"challenge-card " + (answer ? answer.correct ? "success" : "retry" : "")}>
              ...
              {answer && <div className="choice-feedback" aria-live="polite"><span>{answer.correct ? "Montessori çözüm alanı açıldı" : "Bu cümle akıl yürütmeyi daraltıyor"}</span><p>{answer.feedback}</p>{!answer.correct && <button onClick={() => setSelectedChoice(null)}>Başka bir cevap dene ↻</button>}</div>}
            </article>
          </div>
        </section>
      )}
      ...
      {chapter === "guide" && (
        <section className="book-page guide-page page-enter" key={"guide-" + scene.id}>
          <PageHeading number="04" eyebrow="ÖĞRETMEN REHBERİ" title="Kararı verme. Akıl yürütmeyi uyandır." text="İkinci Gelişim Evresi çocuğu toplumsal düzeni araştırır. Yetişkin, çözümün sahibi değil; düşünmenin güvenli danışmanıdır." onHome={() => goChapter("cover")} />
          <ScenarioPicker sceneIndex={sceneIndex} onSelect={selectScene} />
